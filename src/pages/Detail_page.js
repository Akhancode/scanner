...
ws_pair_usdt.onmessage = (event)=>{
console.log("loading Trade data")               
console.log(event.data)
setPairUsdtData(JSON.parse(event.data))
  ...
  return (
    ...
    <nav style={{}}>
        {/* BUTTON WITH DIV */}
            <button style={{  all: "unset",padding:"20px", cursor: "pointer"}}onClick={()=>{
                console.log(ws.readyState)
                console.log(ws.OPEN)
                console.log("clicked")}}>
    ...
    <div className='liveDataContainer'>
        ...
        <div className='symbolDiv' style={{height:"10vh" ,marginBottom:"3vh"}}>
            <text className='symbolText' style={{fontSize:"30px"}}>COIN</text>
        </div>
        <div className='priceDiv' style={{height:"10vh",marginBottom:"3vh"}}>
            <text className='priceText' style={{fontSize:"30px",color:'#484848'}}>PRICE</text>
        </div>
        <div className='profitDiv' style={{height:"10vh",marginBottom:"3vh"}}>
            <text className='priceText' style={{fontSize:"30px"}}>PROFIT</text>
        </div>

        {/* MAJOR DATA */}
        <div className='symbolDiv'>
            <text className='symbolText' >{symbol}</text>
        </div>
        <div className='priceDiv'>
            <text className='priceText' >$ {Math.round(usdtData.a*100000)/100000} </text>
        </div>
        <div className='profitDiv'>
            ...
            <div style={{margin:"10px", padding:"10px" ,borderRight:"solid",borderColor:"white"}} >
                <h4 style={{color:"white"}}>Zero Risk</h4>
                <text className='priceText'  style={{fontSize:"30px"}} >{
                    ( 
            ...
            <div  style={{margin:"10px"}}>
                <h4 style={{color:"white",fontSize:"17px"}}>Risky</h4>
                <text className='priceText'  style={{fontSize:"17px"}} >{
                    (
        ...
        <div className='symbolDiv' style={{height:"10vh" ,marginTop:"5vh",marginBottom:"3vh"}}>
            <text className='symbolText' style={{fontSize:"20px"}}>BUY {symbol}/USDT</text>
        </div>
        <div className='priceDiv' style={{height:"10vh" ,marginTop:"5vh",marginBottom:"3vh"}}>
            <text className='priceText' style={{fontSize:"20px"}}>Sell {symbol}/{pair}</text>
        </div>
        <div className='profitDiv' style={{height:"10vh" ,marginTop:"5vh",marginBottom:"3vh"}}>
            <text className='priceText' style={{fontSize:"20px"}}>SELL {pair}/USDT</text>
        </div>
        ...
        <div className='symbolDiv'>
            ...
            <text className='priceText' style={{fontSize:"32px",color:"#484848"}}>Asks : {usdtData.a}</text>
            <text className='priceText' style={{fontSize:"23px" ,color:"#484848"}}>Bids : {usdtData.b}</text>
            </div>
        </div>
        <div className='priceDiv'>
            <div className='bidaskContainer'>

            <text className='priceText' style={{fontSize:"23px"}}>Asks : {btcData.a}</text>
            <text className='priceText' style={{fontSize:"32px"}}>Bids : {btcData.b}</text>
            </div>
        </div>
        <div className='profitDiv'>
        <div className='bidaskContainer'>

                <text className='priceText' style={{fontSize:"23px"}}>Asks : {pairUsdtData.a}</text>
                <text className='priceText' style={{fontSize:"32px"}}>Bids : {pairUsdtData.b}</text>
                </div>
        </div>
